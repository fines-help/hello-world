...
<?php if ($the_query->have_posts()) : ?>
  <p class="home-seminar-more" style="text-align: right; margin-bottom: 20px;"><a href="<?php echo esc_url(home_url('/contents/seminar/')); ?>" class="btn btn-a">もっとみる<svg viewBox="0 0 22.002 21.998" class="arrow-right">
